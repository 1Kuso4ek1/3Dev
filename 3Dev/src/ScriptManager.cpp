...
void ScriptManager::RegisterModel()
{
    ...
    AddType("Model", sizeof(Model),
    {
        ...
        { "void SetMaterial(Material@, uint = 0)", WRAP_MFN(Model, SetMaterialSlot) },
        ...
        { "AnimationState GetAnimationState(uint = 0)", WRAP_MFN(Model, GetAnimationState) },
        { "void PlayAnimation(uint = 0)", WRAP_MFN(Model, PlayAnimation) },
        { "void StopAnimation(uint = 0)", WRAP_MFN(Model, StopAnimation) },
        { "void PauseAnimation(uint = 0)", WRAP_MFN(Model, PauseAnimation) },
        { "void RepeatAnimation(bool, uint = 0)", WRAP_MFN(Model, RepeatAnimation) },
