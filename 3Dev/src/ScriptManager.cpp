...
void ScriptManager::RegisterModel()
{
    AddType("Model", sizeof(Model),
    {
        ...
        { "void CreateBoxShape(uint = 0, Transform = Transform())", WRAP_MFN(Model, CreateBoxShape) },
        { "void CreateSphereShape(uint = 0, Transform = Transform())", WRAP_MFN(Model, CreateSphereShape) },
        { "void CreateCapsuleShape(uint = 0, Transform = Transform())", WRAP_MFN(Model, CreateCapsuleShape) },
        { "void CreateConcaveShape(uint = 0, Transform = Transform())", WRAP_MFN(Model, CreateConcaveShape) },
        { "void CreateConvexShape(uint = 0, Transform = Transform())", WRAP_MFN(Model, CreateConvexShape) },
...
void ScriptManager::RegisterCamera()
{
    AddType("Camera", sizeof(Camera),
    {
        ...
        { "void SetPitchAndYaw(const Vector2& in)", WRAP_MFN(Camera, SetPitchAndYaw) },
        { "void SetUpVector(const Vector3& in)", WRAP_MFN(Camera, SetUpVector) },
        { "void SetVerticalLimits(const Vector2& in)", WRAP_MFN(Camera, SetVerticalLimits) },
        ...
        { "Vector2 GetPitchAndYaw()", WRAP_MFN(Camera, GetPitchAndYaw) },
        { "Vector3 GetUpVector()", WRAP_MFN(Camera, GetUpVector) },
        { "Vector2 GetVerticalLimits()", WRAP_MFN(Camera, GetVerticalLimits) },
...
void ScriptManager::RegisterRenderer()
{
    ...
    AddType("Renderer", sizeof(Renderer),
    {
        ...
        { "bool IsEyeAdaptationEnabled()", WRAP_MFN(Renderer, IsEyeAdaptationEnabled) },
        { "float GetEyeAdaptationSpeed()", WRAP_MFN(Renderer, GetEyeAdaptationSpeed) },
