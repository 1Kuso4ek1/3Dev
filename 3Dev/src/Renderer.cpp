...
void Renderer::Bloom()
{
    ...
    shaders[ShaderType::Post]->SetUniform1i("fog", 17);
    shaders[ShaderType::Post]->SetUniform1i("ssgi", 18);
    shaders[ShaderType::Post]->SetUniform1i("galbedo", 19);
    shaders[ShaderType::Post]->SetUniform1i("gcombined", 20);
    shaders[ShaderType::Post]->SetUniform1i("decalsCombined", 21);
    shaders[ShaderType::Post]->SetUniform1i("decalsAlbedo", 22);
